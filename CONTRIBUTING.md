# Contributing to ArcadePointsBot
...
Before filing a new issue, please search our [open issues](https://github.com/ArcadeArchie/ArcadePointsBot/issues) to check if it already exists.
...
When ready to submit a bug report, please use the [Bug Report issue template](https://github.com/ArcadeArchie/ArcadePointsBot/issues/new?assignees=&labels=&template=01_bug_report.yml).
